export const metadata = {
  title: 'Terms of Service | FormulaGuard',
  description: 'Terms of Service for FormulaGuard.',
};
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem' }}>
      ...
      <section>
        ...
        <p>As a user of FormulaGuard, you are responsible for:</p>
        <ul>
      ...
      <section>
        ...
        <p>TO THE MAXIMUM EXTENT PERMITTED BY LAW, FORMULAGUARD SHALL NOT BE LIABLE FOR:</p>
        <ul>
      ...
      <section>
        <h2>Contact / Service Provider</h2>
        <p>FormulaGuard is operated by:</p>
        ...
        <p><strong>Contact email:</strong> <a href="mailto:info@formulaguard.com">info@formulaguard.com</a></p>
      </section>
    </div>
  );
}
