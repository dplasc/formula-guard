        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
          ...
          <div className="flex flex-col md:flex-row gap-2 md:gap-3">
            <select
              ...
              className="w-full md:flex-1 min-w-0 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
            >
            ...
            <button
              ...
              className="w-full md:w-auto px-6 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
            >
